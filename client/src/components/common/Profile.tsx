...
const Profile = ({ type, name, avatar, email, properties }: ProfileProps) => (
    <Box mt={"3rem"}>
        ...
        <Box mt="10px" borderRadius="15px" padding="20px" pl="0px" bgcolor="#FCFCFC" sx={{width:"98.5%"}}>
            <Box
                sx={{
                    display: "flex",
        ...
        {properties.length > 0 && (
            <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#FCFCFC">
                <Typography fontSize={18} fontWeight={600} color="#11142D" sx={{display: "flex", justifyContent: "center", alignContent: "center"}}>
                    {type} Rides
                </Typography>
